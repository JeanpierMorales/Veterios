"""
Django settings for Veterios project.
...
SECRET_KEY = 'django-insecure-5%7lr_7u!0$cwhgi2r9sqp=nqqn8)2qpahi_7$s9sb=)=&p%2+'
...
WSGI_APPLICATION = 'Veterios.wsgi.application'
